// ==============================================
// WICS GATEWAY v1.1.0 addOn for nowRail v2.1.2
// 2026-07-12 (c) Bo Holmqvist
// Espressif ESP32-C6 DEV Module 
// ==============================================
...
// I2C
const int SDA_PIN = 11; // ESP32-C6
const int SCL_PIN = 10; // ESP32-C6
//const int SDA_PIN = 10; // ESP32-S3
//const int SCL_PIN = 9; // ESP32-S3

// Default RX485E Buttons ESP32-C6
int buttonA = 21;
int buttonB = 20;
int buttonC = 19;
int buttonD = 18;

// Default RX485E Buttons ESP32-S3
//int buttonA = 14;
//int buttonB = 13;
//int buttonC = 12;
//int buttonD = 11;
...
int clickCount = 0;
#define CLICK_TIMEOUT 3000 // Time Window in milliseconds (3 seconds)
